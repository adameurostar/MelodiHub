...
import 'package:melodihub/ui/rootPage.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    themeMode =
        Hive.box('settings').get('themeMode', defaultValue: 'dark') == 'dark'
            ? ThemeMode.dark
  ...
  try {
    final audioHandler = await AudioService.init(
      ...
      config: const AudioServiceConfig(
        androidNotificationChannelId: 'com.bluesky93128.melodihub.channel',
        androidNotificationChannelName: 'MelodiHub',
